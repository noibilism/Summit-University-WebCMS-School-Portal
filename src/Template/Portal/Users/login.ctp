...
<dir class="action-link">
    <?=$this->Html->link(__('Lost password?'), ['prefix' => 'portal', 'controller' => 'Users', 'action' => 'los
    tPassword'])?>
    <?=App\Core\Setting::read('Member.AnyoneCanRegister')?$this->Html->link(__('Register'), ['prefix' => 'portal', 'controller' => 'Users', 'action' => 'register']):''?>
</dir>
