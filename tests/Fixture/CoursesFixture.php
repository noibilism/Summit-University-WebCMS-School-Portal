...
class CoursesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'school_session_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'description' => ['type' => 'text', 'length' => null, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
        'type' => ['type' => 'integer', 'length' => 1, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '1=>Admissions, 2=>Tuition, 3=>Medical, 4=>Hostel, 5=>LateRegistration, 6=>Other', 'precision' => null, 'autoIncrement' => null],
        ...
        '_indexes' => [
            'fk_fees_session_idx' => ['type' => 'index', 'columns' => ['school_session_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_fees_session' => ['type' => 'foreign', 'columns' => ['school_session_id'], 'references' => ['school_sessions', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
