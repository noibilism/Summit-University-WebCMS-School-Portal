 ...
 *
 */
class CoursewaresFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_cw_dept_idx' => ['type' => 'index', 'columns' => ['department_id'], 'length' => []],
            'fk_cw_staff_idx' => ['type' => 'index', 'columns' => ['content_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_cw_dept' => ['type' => 'foreign', 'columns' => ['department_id'], 'references' => ['departments', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'fk_cw_content' => ['type' => 'foreign', 'columns' => ['content_id'], 'references' => ['contents', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
