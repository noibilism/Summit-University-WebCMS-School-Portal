...
class TransactionsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'reference_no' => ['type' => 'string', 'length' => 45, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_indexes' => [
            'fk_transaction_user_id_idx' => ['type' => 'index', 'columns' => ['user_id'], 'length' => []],
            'fk_transaction_fee_idx' => ['type' => 'index', 'columns' => ['fee_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_transaction_user_id' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'fk_transaction_fee' => ['type' => 'foreign', 'columns' => ['fee_id'], 'references' => ['fees', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
